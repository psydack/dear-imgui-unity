...
namespace ImGuiNET.Unity
{
	...
	/// </summary>
	internal sealed class ImGuiPlatformInputSystem : IImGuiPlatform
	{
		private int[] _mainKeys;                                                        // main keys
		private readonly List<char> _textInput = new List<char>();                      // accumulate text input
		...
		private Keyboard _keyboard = null;                                              // currently setup keyboard, need to reconfigure on changes
